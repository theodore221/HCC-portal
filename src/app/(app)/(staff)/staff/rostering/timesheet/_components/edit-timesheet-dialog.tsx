...
type Props = { timesheet: TimesheetRow };

export function EditTimesheetDialog({ timesheet }: Props) {
      ...
      <DialogContent className="max-w-md">
        ...
        <form onSubmit={handleSubmit} className="space-y-4 text-sm">
          {timesheet.rejection_reason && (
            <div className="rounded-lg bg-status-clay/10 px-3 py-2 text-xs text-status-clay">
