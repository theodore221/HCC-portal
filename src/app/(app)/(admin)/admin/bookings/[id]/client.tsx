...
export default function BookingDetailClient({
  ...
  const handlePrint = useReactToPrint({
    ...
    documentTitle: `Booking_Summary_${booking.reference || booking.id}`,
  });
        ...
        <Card className="shadow-soft p-0 gap-0">
          <CardHeader className="flex flex-col md:flex-row justify-between items-start gap-4 p-6 pb-2">
            ...
            <div className="flex flex-wrap items-center gap-3 md:justify-end w-full md:w-auto">
              ...
              <Button variant="outline" size="sm" asChild className="ml-0">
                <Link
                  ...
                  <DialogContent>
                    <DialogHeader>
                      ...
                      <DialogDescription>
                        ...
                        action will change the status to Cancelled.
                      </DialogDescription>
                    </DialogHeader>
                  ...
                  <DialogContent>
                    <DialogHeader>
                      ...
                      <DialogDescription>
                        ...
                        all related records (meals, reservations, etc.).
                      </DialogDescription>
                    </DialogHeader>
                    <DialogFooter>
                      <Button
