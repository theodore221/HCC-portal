...
import type { BookingSummary, RoomSummary } from "@/lib/models";
...
export function BookingDetailClient({ booking, mealJobs, rooms }: BookingDetailClientProps) {
  return (
    <Tabs defaultValue="overview" className="space-y-6">
      ...
      <TabsContent value="overview" className="space-y-6 p-6">
        ...
        <section className="space-y-3">
          ...
          <div className="grid gap-4 md:grid-cols-3">
            ...
            />
            <InfoBlock label="Spaces" value={booking.spaces.join(", ") || "TBC"} />
            <InfoBlock
              label="Conflicts"
          ...
          <div className="rounded-xl border border-olive-100 bg-white p-4">
            ...
            <ul className="mt-3 space-y-2 text-sm text-olive-800">
              {booking.spaces.length ? (
                ...
                <li className="text-xs text-olive-500">No spaces allocated yet.</li>
              )}
            </ul>
          </div>
          <div className="rounded-xl border border-olive-100 bg-white p-4">
      ...
      <TabsContent value="docs" className="space-y-6 p-6">
        <section className="space-y-3">
          ...
          <div className="rounded-xl border border-olive-100 bg-white p-4 text-sm text-olive-700">
            Uploads and contracts placeholder.
          </div>
        </section>
      </TabsContent>
    </Tabs>
