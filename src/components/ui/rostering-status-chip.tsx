...
const STATUS_CONFIG: Record<string, { label: string; classes: string }> = {
  ...
  InProgress: { label: "In Progress",classes: "border-status-slate/20 bg-status-slate/10 text-status-slate" },
  Completed:  { label: "Completed",  classes: "border-status-forest/20 bg-status-forest/10 text-status-forest" },
  Cancelled:  { label: "Cancelled",  classes: "border-status-clay/20 bg-status-clay/10 text-status-clay" },
  // Assignment statuses
